              ...
              return (
                <button
                  ...
                  className={`rounded-full px-3 py-1 text-xs transition ${
                    active
                      ? "bg-emerald-400 text-slate-950 font-medium shadow"
                  ...
                  {stats.topLabels.map((item, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-400/10 text-[11px] text-emerald-300">
                          #{idx + 1}
                        </span>
