    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <header className="mb-6">
        <div className="flex items-center justify-between">
          ...
          {isRecording && (
            <div className="inline-flex items-center gap-2 rounded-full border border-red-500/50 bg-red-500/10 px-4 py-2 text-red-200">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          <motion.div 
            className="relative flex justify-center items-center border border-slate-800 rounded-2xl p-2 shadow-[0_0_35px_rgba(15,23,42,0.9)] bg-slate-950/80 backdrop-blur-xl w-full"
          >
            <Webcam
              ref={webcamRef}
        ...
        {/* Info Panel */}
        <aside className="w-full lg:w-[280px] bg-slate-950/80 border border-slate-800 rounded-2xl p-5 shadow-[0_0_35px_rgba(0,0,0,0.7)] backdrop-blur-xl text-sm flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs text-slate-400">
              ...
              <div className="flex items-center justify-between">
                <span>Model</span>
                <span className="text-slate-200">COCO-SSD</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Trigger</span>
            ...
            <div className="border-t border-slate-800 pt-4">
              ...
              <ul className="space-y-1.5 text-[11px] text-slate-400">
                <li className="flex items-center gap-2">
                  ...
                  Auto starts when person detected
                </li>
                <li className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-cyan-400" />
                  Stops if no person for {noPersonStopTime}s
                </li>
                <li className="flex items-center gap-2">
          ...
          <p className="text-[11px] text-slate-500 mt-4">
            Ensure camera permissions are enabled. Use well-lit area for better accuracy.
          </p>
        </aside>
      </div>
    </div>
